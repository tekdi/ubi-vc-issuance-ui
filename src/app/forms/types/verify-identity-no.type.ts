      ...
      <div>
        <span class="fw-bold p12">{{ to.label }}</span> <br>
         <div class="d-flex">
              ...
              [(ngModel)]="number" type="input" [ngClass]="(isIdentityNo) ? 'form-control' : 'form-control is-invalid'" />
              <span class="text-primary-color fw-bold p-1 p14" *ngIf="!isVerify"  (click)="verifyOtp()" data-toggle="modal" data-target="#verifyOtp">Verify</span>
