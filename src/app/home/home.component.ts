...
export class HomeComponent implements OnInit {
  ...
  checkHtmlFile(): Observable<any> {
    return this.httpClient
      .get("/assets/config/home.html", { responseType: "text" })
      .pipe(
        map((html: any) => {
          return html;
        }),
  ...
  postFile() {
    ...
    let authUrl = `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=${
      this.clientId
