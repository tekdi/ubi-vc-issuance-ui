...
export class AttestationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.generalService.getData(this.apiUrl).subscribe((res) => {
      ...
      if (res.claim) {
        ...
        let noteDesc =
          "This note will be sent to " + this.claimData?.requestorName;
        ...
        this.schemaService.getFormJSON().subscribe((FormSchemas) => {
          ...
          this.generalService
            .getData("/" + this.claimData.propertyURI)
            .subscribe((res) => {
          ...
          this.generalService
            .getData(this.claimEntity + "/" + this.claimEntityId)
            .subscribe((res) => {
  ...
  generateData() {
    for (const [index, [key, value]] of Object.entries(
      Object.entries(this.attestationData)
    )) {
  ...
  onAttestApproveReject(action, event) {
    ...
    let url = this.entity + "/claims/" + this.claimId + "/attest";
