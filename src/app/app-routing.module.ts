...
const routes: Routes = [
  ...
  {
    path: ":entity/list/:table",
    component: TablesComponent,
    canActivate: [AuthGuard],
  },
  {
    path: ":entity/list/:table/:id",
    component: AttestationComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: "records/:document/:osid",
    component: GetRecordsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "add-records/:document/:osid",
    component: AddRecordsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "bulk-records/:osid",
    component: BulkRecordsComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "bulk-records/:document/:osid",
    component: BulkRecordsComponent,
    canActivate: [AuthGuard],
  },
  ...
  {
    path: "preview-html",
    component: PreviewHtmlComponent,
    canActivate: [AuthGuard],
  },
  { path: "pdf-view", component: PdfViewComponent, canActivate: [AuthGuard] },
  {
    path: "pdf-view/:document/:id",
    component: PdfViewComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "pdf-view/certificate/:id",
    component: PdfViewComponent,
    canActivate: [AuthGuard],
  },
  {
    path: "pdf-view/:document/:id/:certificateId",
    component: PdfViewComponent,
    canActivate: [AuthGuard],
  },
  {
  ...
  {
    path: ":entity/list/:table/action/upload-result",
    component: UploadResultCompoenent,
  },
