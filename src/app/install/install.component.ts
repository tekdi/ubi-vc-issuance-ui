...
export class InstallComponent implements OnInit {
  ...
  fields: FormlyFieldConfig[] = [
    ...
    },
    {
      ...
      templateOptions: {
        ...
        description:
          "Reference link : https://github.com/ref-registries/edu-core-registries/tree/main/ui-config",
        required: true,
        label:
          "Read config files(forms.json,layouts.json,etc.) from which folder?",
      },
    },
    {
      key: "default_theme",
  ...
  formateData() {
    if (this.model.baseUrl.substring(this.model.baseUrl.length - 1) == "/") {
      this.model.baseUrl = this.model.baseUrl.substring(
        0,
        this.model.baseUrl.length - 1
      );
    }
  }
}
