...
import { SubheaderComponent } from "../app/subheader/subheader.component";
...
import { UploadService } from "../app/services/upload-result/upload-result.service";
  ...
  constructor(translate: TranslateService, authConfig: AuthConfigService) {
    authConfig.getConfig().subscribe((config) => {
      ...
      if (
        ...
        this.languages.includes(localStorage.getItem("setLanguage"))
      ) {
